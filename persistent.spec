...
Version  : 4.6.2
Release  : 37
URL      : https://files.pythonhosted.org/packages/4b/13/1a2c3fa6abf61ef513951029dfe1536eac9098a354c86e5418d5d9feb092/persistent-4.6.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/4b/13/1a2c3fa6abf61ef513951029dfe1536eac9098a354c86e5418d5d9feb092/persistent-4.6.2.tar.gz
...
%prep
%setup -q -n persistent-4.6.2
cd %{_builddir}/persistent-4.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584061621
...
cp %{_builddir}/persistent-4.6.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/persistent/a0b53f43aab58b46bf79ba756c50771c605ab4c5
