...
Version  : 4.6.1
Release  : 36
URL      : https://files.pythonhosted.org/packages/40/a5/d7cc918a82bee67c57ce4bc6bd4202eade63b892ab5733a2a498f516423d/persistent-4.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/40/a5/d7cc918a82bee67c57ce4bc6bd4202eade63b892ab5733a2a498f516423d/persistent-4.6.1.tar.gz
...
%prep
%setup -q -n persistent-4.6.1
cd %{_builddir}/persistent-4.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583522594
...
cp %{_builddir}/persistent-4.6.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/persistent/a0b53f43aab58b46bf79ba756c50771c605ab4c5
