...
Version  : 4.6.3
Release  : 38
URL      : https://files.pythonhosted.org/packages/13/f3/0b788d1764b271615a7398b537eb8aa062a79074c41d79acea2f1dac7d93/persistent-4.6.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/13/f3/0b788d1764b271615a7398b537eb8aa062a79074c41d79acea2f1dac7d93/persistent-4.6.3.tar.gz
...
%prep
%setup -q -n persistent-4.6.3
cd %{_builddir}/persistent-4.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584634517
...
cp %{_builddir}/persistent-4.6.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/persistent/a0b53f43aab58b46bf79ba756c50771c605ab4c5
